...
const create_user_dto_1 = require("../helpers/Dto/create-user.dto");
const update_user_dto_1 = require("../helpers/Dto/update-user.dto");
let UserController = class UserController {
    ...
    async deleteStudent(response, userId) {
        try {
